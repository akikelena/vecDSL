import pandas as pd
from jaguardb import JaguarDBClient, CollectionSchema, FieldSchema, DataType

client = JaguarDBClient(host="localhost", port=8000)
...
print("JaguarDB Vector Search Results:")
print(results)
...
print("JaguarDB Non-Vector Query Results:")
